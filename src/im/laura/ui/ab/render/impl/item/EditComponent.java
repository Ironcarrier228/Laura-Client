package im.laura.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import im.laura.Laura;
import im.laura.ui.ab.render.impl.AddedItemComponent;
import im.laura.ui.ab.render.impl.AllItemComponent;
import im.laura.ui.ab.render.impl.Component;
import im.laura.utils.client.IMinecraft;
import im.laura.utils.components.ButtonComponent;
import im.laura.utils.components.FieldComponent;
import im.laura.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            Laura.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
