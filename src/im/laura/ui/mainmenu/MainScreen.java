package im.laura.ui.mainmenu;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.platform.GlStateManager;
import im.laura.Laura;
import im.laura.utils.client.ClientUtil;
import im.laura.utils.client.IMinecraft;
import im.laura.utils.client.Vec2i;
...
import im.laura.utils.render.Stencil;
...
public class MainScreen extends Screen implements IMinecraft {
    ...
    private final ResourceLocation backmenu = new ResourceLocation("laura/images/backmenu.png");
    private final ResourceLocation logo = new ResourceLocation("laura/images/logo.png");
    ...
    public void init(Minecraft minecraft, int width, int height) {
        ...
        float y = Math.round(height / 2f + 1);
        buttons.clear();
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        Laura.getInstance().getAltWidget().updateScroll((int) mouseX, (int) mouseY, (float) delta);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        Laura.getInstance().getAltWidget().render(matrixStack, mouseX, mouseY);
    ...
    public boolean charTyped(char codePoint, int modifiers) {
        Laura.getInstance().getAltWidget().onChar(codePoint);
        return super.charTyped(codePoint, modifiers);
    }

    @Override
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        Laura.getInstance().getAltWidget().onKey(keyCode);
        return false;
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        Laura.getInstance().getAltWidget().click((int) mouseX, (int) mouseY, button);
    ...
    public static final ResourceLocation button = new ResourceLocation("laura/images/button.png");
