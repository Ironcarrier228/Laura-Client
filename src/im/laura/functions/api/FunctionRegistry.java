package im.laura.functions.api;

import com.google.common.eventbus.Subscribe;
import im.laura.Laura;
import im.laura.events.EventKey;
import im.laura.functions.impl.combat.*;
import im.laura.functions.impl.misc.*;
import im.laura.functions.impl.misc.FakePlayer;
import im.laura.functions.impl.movement.*;
import im.laura.functions.impl.movement.Velocity;
import im.laura.functions.impl.player.*;
import im.laura.functions.impl.render.*;
import im.laura.utils.render.font.Font;
...
public class FunctionRegistry {
    ...
    private im.laura.functions.impl.movement.Velocity velocity;
    private NoRender noRender;
    private im.laura.functions.impl.movement.Timer timer;
    ...
    private PearlChaser pearlChaser;
    ...
    public void init() {
        registerAll(
                ...
                velocity = new im.laura.functions.impl.movement.Velocity(),
                noRender = new NoRender(),
                timer = new im.laura.functions.impl.movement.Timer(),
    ...
    public Function getFunction(String name) {
        return functions.stream().filter(f -> f.getName().equalsIgnoreCase(name)).findFirst().orElse(null);
    }
