...
import im.laura.ui.display.impl.*;
...
public class HUD extends Function {
    ...
    public HUD() {
        ...
        Dragging potions = Laura.getInstance().createDrag(this, "Potions", 278, 5);
        Dragging keyBinds = Laura.getInstance().createDrag(this, "KeyBinds", 185, 5);
        Dragging dragging = Laura.getInstance().createDrag(this, "TargetHUD", 74, 128);
        Dragging staffList = Laura.getInstance().createDrag(this, "StaffList", 96, 5);
        Dragging armorList = Laura.getInstance().createDrag(this, "ArmorHUD", 250, 5);
    ...
    public static int getColor(int index) {
        StyleManager styleManager = Laura.getInstance().getStyleManager();
