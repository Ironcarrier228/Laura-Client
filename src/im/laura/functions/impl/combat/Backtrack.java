...
public class Backtrack extends Function {
    ...
    private final SliderSetting delay = new SliderSetting("Задержка", 500f, 100f, 2000f, 50f);
    ...
    public Backtrack() {
        addSettings(skip, range, delay, esp, autoDisable);
    }
    ...
    private void onTick(TickEvent e) {
        if (queue.isEmpty() && isTargetNull() || mc.isSingleplayer()) return;
    ...
    private void onRender(WorldEvent e) {
        if (!esp.get() || realPos == null || mc.isSingleplayer()) return;
        ...
        int hurtTime = target instanceof LivingEntity l ? l.hurtTime : 0;
