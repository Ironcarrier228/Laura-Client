...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Laura.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Laura.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Laura.getInstance().getViaMCP().viaScreen.tick();
