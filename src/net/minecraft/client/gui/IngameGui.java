...
import im.laura.events.EventCancelOverlay;
import im.laura.events.EventDisplay;
import im.laura.functions.api.FunctionRegistry;
import im.laura.functions.impl.render.Crosshair;
import im.laura.functions.impl.render.HUD;
...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        if (eventDisplay.getType() == EventDisplay.Type.PRE) {
            Laura.getInstance().getEventBus().post(eventDisplay);
        }
        ...
        if (!this.mc.gameSettings.hideGUI) {
            ...
            Laura.getInstance().getEventBus().post(eventCancelOverlay);
