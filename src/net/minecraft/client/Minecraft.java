...
import im.laura.functions.impl.player.ItemCooldown;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public void setDefaultMinecraftTitle() {
        ...
        if (selfDestruct.unhooked) {
            ...
            this.mainWindow.setWindowTitle("Laura client  0.1 - new cheats starts uwu");
        }
    }
    ...
    private void tick(boolean isDebug, @Nullable LongTickDetector detector) {
        Laura.getInstance().getEventBus().post(tickEvent);
    ...
    public void runTick() {
        ...
        if (this.world != null) {
            Laura.getInstance().getEventBus().post(player.tick);
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        Laura.getInstance().getEventBus().post(new EventChangeWorld());
    }
