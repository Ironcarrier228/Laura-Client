...
import im.laura.events.EventDamageReceive;
...
import im.laura.functions.impl.render.SwingAnimation;
...
public abstract class LivingEntity extends Entity {
    ...
    protected void jump() {
        ...
        if (this instanceof ClientPlayerEntity entity) {
            Laura.getInstance().getEventBus().post(jumpEvent);
        }
