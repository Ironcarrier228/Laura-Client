...
import im.laura.events.EventStartRiding;
import im.laura.events.MovingEvent;
import im.laura.events.PostMoveEvent;
import im.laura.functions.api.FunctionRegistry;
import im.laura.functions.impl.combat.Hitbox;
import im.laura.functions.impl.render.Trails;
import im.laura.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Laura.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Laura.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Laura.getInstance().getEventBus().post(new EventStartRiding(entityIn));
